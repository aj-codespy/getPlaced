      ...
      <main className="relative z-10 flex-1 max-w-3xl mx-auto px-6 py-16 w-full">
        ...
        <div className="space-y-10 text-slate-300 leading-relaxed text-sm">
          ...
          <section>
            ...
            <p className="mt-4">
              To request a refund under these conditions, you must email <a href="mailto:support@getplaced.in" className="text-indigo-400 hover:underline">support@getplaced.in</a> within 7 days of the transaction.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              For any payment or billing questions, please reach out to our team at <a href="mailto:support@getplaced.in" className="text-indigo-400 hover:underline">support@getplaced.in</a>. We strive to respond within 24-48 hours.
            </p>
          </section>
        </div>
      </main>
